...
dir_patch = 'data'
protocol_type = 'fcsNotificationEA44'

key_list = ('fcsNotificationEF',
            'responsibleOrg',
            'collecting',
            'bidding',
            'customer',
...
def parse_to_db(files):
    ...
    for f in files:
        notif_info_list = ('fcsNotificationEF',
                           'collecting',
                           'quantity',
                           'OKPD2',
                           'bidding',
        ...
        for i in parse_xml(f):
            ...
            if tuple(i)[0][0] == 'contractGuarantee':
                ...
                if tuple(i)[0][1] == 'part':
                    if float(i[tuple(i)[0]]) > 1:
                        notif_info['contractGuarantee_pers'] = float(i[tuple(i)[
                            0]]) / 100
                    else:
                        notif_info['contractGuarantee_pers'] = i[tuple(i)[0]]
